...
class PredictionTools:
    ...
    def __init__(self):
        ...
        self.mm_age = load_pickle("/API/parameters/age_scaler.pkl")

        self.mm_weight = load_pickle("/API/parameters/weight_scaler.pkl")

        self.mm_ap_hi = load_pickle("/API/parameters/ap_hi_scaler.pkl")
        
        self.mm_ap_lo = load_pickle("/API/parameters/ap_lo_scaler.pkl")

        self.model = load_pickle("/API/models/model.pkl")
    ...
    def data_preparation(self, data):
        ...
        # change dictionary value into a list to better create the dataframe
